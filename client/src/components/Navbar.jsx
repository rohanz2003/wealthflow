...
import { FiHome, FiDollarSign, FiCheckCircle, FiTarget, FiTrendingUp, FiLogOut, FiMenu, FiX, FiShield, FiMoon, FiSun, FiSettings, FiPieChart, FiBarChart2, FiTrendingDown, FiUser } from 'react-icons/fi';
...
export default function Navbar() {
  ...
  return (
    <nav className="sticky top-0 z-50 bg-white/90 dark:bg-navy-900/90 backdrop-blur-md border-b border-gray-200 dark:border-navy-700">
        ...
        <div className="flex justify-between h-14 sm:h-16">
          <div className="flex items-center">
            <Link to="/dashboard" className="flex items-center space-x-2">
              ...
              <span className="text-base sm:text-xl font-bold text-gray-900 dark:text-white">WealthFlow</span>
            </Link>
          </div>
          ...
          <div className="hidden md:flex items-center space-x-1">
            ...
            <div className="ml-3 pl-3 border-l border-gray-200 dark:border-navy-700 flex items-center space-x-2">
      ...
      {mobileOpen && (
        <div className="md:hidden border-t border-gray-200 dark:border-navy-700 bg-white dark:bg-navy-900 shadow-lg">
